Public Class L03
    Public Declare Sub Out Lib "io.dll" Alias "PortOut" (ByVal PortAddress As Short, ByVal PortData As Byte)
    Public Declare Function inp Lib "io.dll" Alias "PortIn" (ByVal PortAddress As Short) As Byte
